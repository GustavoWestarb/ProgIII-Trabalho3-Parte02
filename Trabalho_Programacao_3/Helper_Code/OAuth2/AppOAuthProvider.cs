...
namespace Trabalho_Programacao_3.Helper_Code.OAuth2
{
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        /// </summary>
        private Context databaseManager = new Context();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = databaseManager.Users.FirstOrDefault(x => x.Email == usernameVal);

            if (user != null && !Encryption.Compare(passwordVal, user?.Password))
            {
                user = null;
            }
